...
function FoodItem({ fooditem, restaurant }) {
  ...
  const { isAuthenticated, user } = useSelector((state) => state.auth); // Corrected useSelector usage
  ...
  return (
    <div className='col-sm-12 col-md-6 col-lg-3 my-3'>
      <div className='card p-3 rounded'>
        <img
          src={fooditem.images && fooditem.images[0] ? fooditem.images[0].url : '/defaultImage.jpg'}
          alt={fooditem.name}
